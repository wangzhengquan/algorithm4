...
public final class StdRandom {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < n; i++) {
      edu.princeton.cs.algs4.StdOut.printf("%2d ", uniformInt(100));
      edu.princeton.cs.algs4.StdOut.printf("%8.5f ", uniformDouble(10.0, 99.0));
      ...
      edu.princeton.cs.algs4.StdOut.printf("%11d ", uniformLong(100000000000L));
      StdRandom.shuffle(a);
      for (String s : a)
