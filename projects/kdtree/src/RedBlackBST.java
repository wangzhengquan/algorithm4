...
////    shuffle(keys);
//    RedBlackBST<String, Integer> st = testPut(keys);
////    StdDraw.pause(2000);
//    st.deleteMin();
//    st.drawTree();
//
...
//    testDesignateDel(st, delkeys);
  ...
  private static void testRandomDel(RedBlackBST<String, Integer> st) {
...
//      st.printTree();
  ...
  //A X T L Z
  private static void testDesignateDel(RedBlackBST<String, Integer> st, String[] keys) {
...
//      st.printTree();
  ...
  private static void testOrderedDel(RedBlackBST<String, Integer> st) {
...
//      st.printTree();
  ...
  private static RedBlackBST<String, Integer> testPut(String[] keys) {
