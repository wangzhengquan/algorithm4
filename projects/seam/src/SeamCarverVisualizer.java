...
public class SeamCarverVisualizer implements ActionListener {
  JFrame frame;
  SeamCarver sc;

  public SeamCarverVisualizer(SeamCarver sc) {
    this.sc = sc;
  }

  public void visualizeHorizontalCarve(int N) {
  ...
  public void visualizeVerticalCarve(int N) {
    for (int i = 0; i < N; i++) {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (chooser.getFile() != null) {
      sc.picture().save(chooser.getDirectory() + File.separator + chooser.getFile());
    }
  }

  //HJoceanSmall.png 150 n, chameleon.png
  public static void main(String[] args) {
    ...
    SeamCarverVisualizer scv = new SeamCarverVisualizer(sc);
    if (args[2].equals("y")) {
      scv.visualizeHorizontalCarve(N);
    } else {
      scv.visualizeVerticalCarve(N);
    }
  }
